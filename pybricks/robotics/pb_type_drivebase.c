...
STATIC const mp_obj_type_t pb_type_DriveBaseWait = {
    .base.type = &mp_type_type,
    .name = MP_QSTR_DriveBaseWait,
    .getiter = mp_identity_getiter,
    .iternext = pb_type_DriveBaseWait_iternext,
    .locals_dict = (mp_obj_dict_t *)&pb_type_DriveBaseWait_locals_dict,
};
