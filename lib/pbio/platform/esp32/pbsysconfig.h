...
#define PBSYS_CONFIG_HMI_STOP_BUTTON                (1 << 0) // button 0
#define PBSYS_CONFIG_HMI_ESP32                      (1)
...
#define PBSYS_CONFIG_STATUS_LIGHT_STATE_ANIMATIONS_HUE (180)  // Cyan for ESP32
